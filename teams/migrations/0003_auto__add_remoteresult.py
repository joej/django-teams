...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RemoteResult'
        db.create_table(u'teams_remoteresult', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
            ('squad', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'teams_remoteresult_squad', to=orm['teams.Squad'])),
            ('code', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'teams', ['RemoteResult'])


    def backwards(self, orm):
        # Deleting model 'RemoteResult'
        db.delete_table(u'teams_remoteresult')
    ...
    models = {
        ...
        u'teams.remoteresult': {
            'Meta': {'object_name': 'RemoteResult'},
            'code': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            'squad': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'teams_remoteresult_squad'", 'to': u"orm['teams.Squad']"})
        },
        u'teams.season': {
